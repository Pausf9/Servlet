...
public class ConexionMySQL {
    ...
    public String bd = "alumnos";
    public String login = "Pau";
    public String password = "pau";
    ...
    /**
     * metodo para borrar los registros donde el usuario el atributo que quieree
     * consultar y el valor que tiene que tener para que sea borrado
     *
    ...
    /**
     * metodo para borrar los registros donde el usuario el atributo que quieree
     * consultar y un valor inicial y uno final y se borraran todos los
     * registros que esten en este rango
     *
     * @param nom_tabla
     * @param campo
     * @param intro
    ...
    /**
     * metodo para mostrar los registro que conciden con lo que introduce el
     * usuario por teclado
     *
     * @param nom_tabla nombre de la tabla donde se va a buscar
     * @param campo atributo por el cual se va a buscar lo que introduce el
     * usuario
    ...
    /**
     * metodo para mostrar los registro que se encuentra en el rango de los dos
     * textos qu ha introducido el usuario
     *
     * @param nom_tabla nombre de la tabla donde se va a buscar
     * @param campo atributo por el cual se va a buscar lo que introduce el
     * usuario
